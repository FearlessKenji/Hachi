...
- authCron - Changes Twitch auth token every hour by default. This is required. Adjust to every minute for first startup, but change back to every hour after initialization.
- twitchAuthToken - Autogenerated auth key for getting twitch usernames. Leave alone.
- kickAuthToken - Autogenerated auth key for getting kick usernames. Leave alone.

All of these fields except twitchAuthToken and kickAuthToken are required.
