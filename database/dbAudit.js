...
const EXPECTED_SCHEMA = [
	{
		...
		columns: [
			...
			column(`socialLinkFixingEnabled`, `TINYINT(1)`, { defaultValue: `0` }),
			column(`hachiAnnouncementChannelId`, `VARCHAR(255)`, { nullable: true }),
			column(`hachiAnnouncementLastId`, `VARCHAR(255)`, { nullable: true }),
			column(`hachiAnnouncementWarningKey`, `VARCHAR(255)`, { nullable: true }),
			column(`hachiAnnouncementWarningCount`, `INTEGER`, { defaultValue: `0` }),
			column(`hachiAnnouncementWarningWindowStartedAt`, `DATETIME`, { nullable: true }),
			column(`hachiAnnouncementWarningLastSentAt`, `DATETIME`, { nullable: true }),
		],
		indexes: [],
	},
	{
	...
	},
	{
		...
		columns: [
			...
			column(`channelId`, `VARCHAR(255)`),
			column(`boardChannelId`, `VARCHAR(255)`, { nullable: true }),
			column(`weekChannelId`, `VARCHAR(255)`, { nullable: true }),
			...
			column(`lastBoardPostDate`, `VARCHAR(255)`, { nullable: true }),
			column(`boardMessageId`, `VARCHAR(255)`, { nullable: true }),
		],
		indexes: [],
	},
	{
		...
		columns: [
			...
			column(`year`, `INTEGER`),
			column(`url`, `TEXT`),
			column(`deliveryUrl`, `TEXT`, { nullable: true }),
	...
	{
		name: `commandMonitorWhitelists`,
		columns: [
			column(`id`, `INTEGER`, { autoIncrement: true, primaryKey: true }),
			column(`guildId`, `VARCHAR(255)`, { references: `servers (guildId) ON DELETE RESTRICT ON UPDATE CASCADE` }),
			column(`type`, `VARCHAR(255)`),
			column(`targetId`, `VARCHAR(255)`),
			column(`label`, `VARCHAR(255)`, { nullable: true }),
			column(`createdBy`, `VARCHAR(255)`, { nullable: true }),
			column(`createdAt`, `DATETIME`),
		],
		indexes: [
			index(`commandMonitorWhitelistsGuildTypeTarget`, [`guildId`, `type`, `targetId`], { unique: true }),
			index(`commandMonitorWhitelistsGuildType`, [`guildId`, `type`]),
		],
	},
	{
		name: `linkConfigs`,
	...
	{
		name: `twitchVerificationPanels`,
		columns: [
			column(`guildId`, `VARCHAR(255)`, { primaryKey: true, references: `servers (guildId) ON DELETE RESTRICT ON UPDATE CASCADE` }),
			column(`channelId`, `VARCHAR(255)`),
			column(`messageId`, `VARCHAR(255)`, { nullable: true }),
			column(`failureCode`, `VARCHAR(255)`, { nullable: true }),
			column(`lastRepairAt`, `DATETIME`, { nullable: true }),
			column(`warningCount`, `INTEGER`, { defaultValue: `0` }),
			column(`warningWindowStartedAt`, `DATETIME`, { nullable: true }),
			column(`warningLastSentAt`, `DATETIME`, { nullable: true }),
		],
		indexes: [],
	},
	{
		...
		columns: [
			column(`guildId`, `VARCHAR(255)`, { primaryKey: true, references: `servers (guildId) ON DELETE RESTRICT ON UPDATE CASCADE` }),
			column(`enabled`, `TINYINT(1)`, { defaultValue: `0` }),
			column(`quarantineRoleId`, `VARCHAR(255)`, { nullable: true }),
			column(`alertChannelId`, `VARCHAR(255)`, { nullable: true }),
			column(`reportChannelId`, `VARCHAR(255)`, { nullable: true }),
			column(`moderatorRoleId`, `VARCHAR(255)`, { nullable: true }),
			column(`messageSpamCount`, `INTEGER`, { defaultValue: `5` }),
			column(`messageSpamSeconds`, `INTEGER`, { defaultValue: `5` }),
			column(`joinSpikeCount`, `INTEGER`, { defaultValue: `5` }),
			column(`joinSpikeSeconds`, `INTEGER`, { defaultValue: `5` }),
			column(`actionQuarantine`, `TINYINT(1)`, { defaultValue: `1` }),
			column(`actionTimeout`, `TINYINT(1)`, { defaultValue: `0` }),
			column(`actionDelete`, `TINYINT(1)`, { defaultValue: `1` }),
			column(`timeoutMinutes`, `INTEGER`, { defaultValue: `60` }),
		],
		indexes: [],
	},
	{
		...
		columns: [
			...
			column(`endedAt`, `DATETIME`, { nullable: true }),
			column(`summary`, `TEXT`, { nullable: true }),
		],
		indexes: [
			index(`raidIncidentsGuildStarted`, [`guildId`, `startedAt`]),
			index(`raidIncidentsGuildStatus`, [`guildId`, `status`]),
		],
	},
	{
		name: `raidIncidentUsers`,
		columns: [
			column(`id`, `INTEGER`, { autoIncrement: true, primaryKey: true }),
			column(`incidentId`, `INTEGER`, { references: `raidIncidents (id) ON DELETE CASCADE ON UPDATE CASCADE` }),
			column(`guildId`, `VARCHAR(255)`),
			column(`userId`, `VARCHAR(255)`),
			column(`displayName`, `VARCHAR(255)`, { nullable: true }),
			column(`username`, `VARCHAR(255)`, { nullable: true }),
			column(`joinedAt`, `DATETIME`, { nullable: true }),
			column(`actionTaken`, `TEXT`, { nullable: true }),
			column(`actionError`, `TEXT`, { nullable: true }),
			column(`releasedAt`, `DATETIME`, { nullable: true }),
		],
		indexes: [
			index(`raidIncidentUsersIncident`, [`incidentId`]),
			index(`raidIncidentUsersGuildUser`, [`guildId`, `userId`]),
		],
	},
	{
		name: `raidIncidentMessages`,
		columns: [
			column(`id`, `INTEGER`, { autoIncrement: true, primaryKey: true }),
			column(`incidentId`, `INTEGER`, { references: `raidIncidents (id) ON DELETE CASCADE ON UPDATE CASCADE` }),
			column(`guildId`, `VARCHAR(255)`),
			...
			column(`contentHash`, `VARCHAR(255)`, { nullable: true }),
			column(`attachmentsJson`, `TEXT`, { nullable: true }),
			column(`embedsJson`, `TEXT`, { nullable: true }),
			column(`linksJson`, `TEXT`, { nullable: true }),
			column(`deletedAt`, `DATETIME`, { nullable: true }),
			column(`createdAt`, `DATETIME`),
		],
		indexes: [
			index(`raidIncidentMessagesIncident`, [`incidentId`]),
			index(`raidIncidentMessagesIncidentMessage`, [`incidentId`, `messageId`], { unique: true }),
			index(`raidIncidentMessagesGuildUser`, [`guildId`, `userId`]),
		],
	},
	{
		name: `raidIncidentFiles`,
		columns: [
			column(`id`, `INTEGER`, { autoIncrement: true, primaryKey: true }),
			column(`incidentId`, `INTEGER`, { references: `raidIncidents (id) ON DELETE CASCADE ON UPDATE CASCADE` }),
			column(`guildId`, `VARCHAR(255)`),
			column(`messageId`, `VARCHAR(255)`),
			column(`attachmentId`, `VARCHAR(255)`),
			column(`filename`, `VARCHAR(255)`),
			column(`contentType`, `VARCHAR(255)`, { nullable: true }),
			column(`size`, `INTEGER`, { defaultValue: `0` }),
			column(`hash`, `VARCHAR(255)`, { nullable: true }),
			column(`localPath`, `TEXT`, { nullable: true }),
			column(`originalUrl`, `TEXT`, { nullable: true }),
			column(`seenCount`, `INTEGER`, { defaultValue: `1` }),
		],
		indexes: [
			index(`raidIncidentFilesIncident`, [`incidentId`]),
			index(`raidIncidentFilesGuildHash`, [`guildId`, `hash`]),
